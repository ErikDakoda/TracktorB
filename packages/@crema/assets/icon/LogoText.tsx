...
export const LogoText = ({ className, color }) => {
  return (
    <svg viewBox="0 0 100 29.7">
      <g id="freepik--Floor--inject-1--inject-1111">
        <g id="freepik--Floor--inject-1--inject-1111">
          <path fill={color} d="M19.5,13h-7.4v-5c0-1.4-0.1-2.3-0.2-2.7c-0.2-0.4-0.5-0.5-1-0.5c-0.6,0-1,0.2-1.2,0.7
          ...
          <path fill={color} d="M20.9,0.6h5.2c3.5,0,5.9,0.1,7.1,0.4c1.2,0.3,2.2,1,3,2.1c0.8,1.1,1.2,2.9,1.2,5.3c0,2.2-0.3,3.7-0.8,4.5
          ...
          <path fill={color} d="M77.8,0.6v28.5h-6.5l0-19.2l-2.6,19.2h-4.6l-2.7-18.8l0,18.8h-6.5V0.6h9.6c0.3,1.7,0.6,3.7,0.9,6.1l1.1,7.2
			l1.7-13.3H77.8z" />
          <path fill={color} d="M93.7,0.6L98,29.1h-7.6L90,24h-2.6l-0.4,5.1h-7.7L83,0.6H93.7z M89.8,18.9c-0.4-3.2-0.8-7.2-1.1-12
