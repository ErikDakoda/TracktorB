    ...
    <svg className={className} viewBox="0 0 500 500">
      <g fill={color}>
        ...
        <g id="freepik--Shadows--inject-23">
          <path id="freepik--Shadow--inject-23"
        ...
        <g id="freepik--Robot--inject-23">
          <g id="freepik--robot--inject-23">
            ...
            <circle
              ...
              style={{ opacity: 0.25 }} />
            <circle
              cx="270.95" cy="302.08" r="32.34" fill="current" />
            <circle
              cx="270.95" cy="302.08" r="32.34"
              style={{ opacity: 0.35 }} />
            <path
            ...
            <path
              ...
              fill="#37474f" />
            <circle cx="275.79" cy="287.53" r="1.51" fill="current" />
            <circle cx="271.16" cy="289.04" r="0.74" fill="current" />
            <path
            ...
            <path
              ...
              style={{ opacity: 0.25 }} />
            <circle cx="331.84" cy="249.76" r="2.57" fill="#37474f" />
            <ellipse cx="251.4" cy="230.74" rx="37.28" ry="21.52" fill="current" />
            ...
            <path
              ...
              style={{ opacity: 0.15 }} />
            <circle cx="247.94" cy="119.42" r="8.14" fill="current" />
            <path
            ...
            <path
              ...
              fill="#e0e0e0" />
            <path d="M269.81,120.46h-7a1,1,0,0,1,0-2h7a1,1,0,0,1,0,2Z" fill="#e0e0e0" />
            <path
            ...
            <path
              ...
              fill="#e0e0e0" />
            <path d="M233.09,120.38h-7a1,1,0,0,1,0-2h7a1,1,0,1,1,0,2Z" fill="#e0e0e0" />
            <path
        ...
        <g id="freepik--error-404--inject-23">
          <g id="freepik--404--inject-23">
            <g id="freepik--shadow--inject-23">
              <path d="M171.44,82.27l3.23-1.87V74.15Z" fill="#e0e0e0" />
            </g>
            <g id="freepik--404--inject-23">
              <path
