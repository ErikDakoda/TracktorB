...
export const Error500Icon = ({ className, color }: IconComponentProps) => {
  return (
    <svg className={clsx('error-500-icon', className)} viewBox="0 0 500 500">
      <g id="Floor--inject-3">
        <ellipse id="floor--inject-3" cx="250" cy="378.78" rx="230.68"
                 ry="112.11" fill="#f5f5f5" />
      </g>
      <g id="Shadows--inject-3">
        <path id="Shadow--inject-3"
        ...
        <path id="shadow--inject-3"
          ...
          <path id="shadow--inject-3"
                ...
                fill="#e6e6e6" />
          <ellipse id="shadow--inject-3" cx="387.02" cy="400.95"
                   rx="57.04" ry="32.93" fill="#e6e6e6" />
          <polygon id="shadow--inject-3"
      ...
      <g id="Server--inject-3">
        <g id="server--inject-3">
          ...
          <path
            ...
            fill="#263238" />
          <path d="M175.26,327.7l0,0-.89-.52.26-.16c.07-.05.15-.05.18,0Z"
                style={{ opacity: 0.15 }} />
          <path
          ...
          <path
            ...
            style={{ opacity: 0.1 }} />
          <path d="M175.32,318.88a.27.27,0,0,1,.14-.07h.17"
                fill="none" />
          <path
          ...
          <path
            ...
            fill={color} />
          <ellipse cx="119.33" cy="159.77" rx="2.18" ry="1.26"
                   fill="#263238" />
          <path
      ...
      <g id="Screwdriver--inject-3">
        <g id="screwdriver--inject-3">
          ...
          <path
            d="M258.36,418.59a12,12,0,0,0-5.42-9.39c-3-1.73-5.42-.32-5.42,3.13a12,12,0,0,0,5.42,9.38C255.93,423.44,258.36,422,258.36,418.59Z"
            style={{ opacity: 0.15 }} />
          <path d="M250.83,420a10.68,10.68,0,0,0,1.34,1.2l1.27-3.61-1.53-1.13Z"
                style={{ opacity: 0.15 }} />
          <path
      ...
      <g id="Character--inject-3">
        <g id="character--inject-3">
          ...
          <path
            ...
            fill="#e0e0e0" />
          <path d="M344,200.76A13.6,13.6,0,0,1,348,208.3s1.26-4.15-3.11-8.82Z"
                fill="#f28f8f" />
          <path
