    ...
    <svg className={className} viewBox="0 0 500 500">
      ...
      <g id="Plant--inject-3">
        <path
          ...
          fill={color} />
        <path
          d="M98 .66, 330.05l - 9.15, 5.32s4 .62-14.74, 2.06-29.56 A28.4, 28.4, 0, 0, 0, 87.85, 296c - .72 - 1.5 - 6.23 - 10.74 - 1.38 - 15 s16.25, 4.21, 15.73, 27A88 .7, 88.7, 0, 0, 1, 98.66, 330.05Z"
          style={{ opacity: 0.3 }}
        />
        < path
          d="M94 .41, 333l - .15, 0a .42.42, 0, 0, 1-.25 - .54 c0-.1, 3.44-9.57, 3.26-24.81 s-8.08 - 23.17 - 8.16 - 23.25 a.43 .43, 0, 0, 1, 0-.6 .42.42, 0, 0, 1, .6, 0c .08.08, 8.23, 8.34, 8.41, 23.84s - 3.28, 25-3.31, 25.11A .44.44, 0, 0, 1, 94.41, 333Z"
          fill="#fff" />
        <path
          d="M91 .57, 334.2l - 15.11, 8.89s - 6.92 - 1 - 6.4 - 7.53, 3.34-8.05 - .16 - 10.91 - 4.41 - 3 - 4.24 - 5.86, 2-4, 2.94-5.14, 3.36-3.44, 1.62-6.82 - 4.1 - 6.65 - .59 - 8.2 c2.09 - .93, 5.6.23, 7.94, 2.71s4 .25, 4.25, 6.46, 4.82, 6.81.63, 6.66, 4.43-1.15, 5.12-.22, 6.81C92 .21, 320.58, 99.63, 322.3, 91.57, 334.2Z"
          fill={color} />
        <path
      ...
      <g id="Device--inject-3">
        ...
        <path
          ...
          fill="#263238" />
        <polygon
          points="399.48 143.27 385.46 151.36 385.46 157.68 399.48 149.59 399.48 143.27"
          fill="#37474f" />
        <path
        ...
        <polygon
          points="281.83 57.78 283.69 65.59 323.33 88.45 330.18 84.8 281.83 57.78"
          fill="#455a64" />
        <path
      ...
      <g id="Screen--inject-3">
        ...
        <ellipse cx="262.11" cy="203.39" rx="34.06" ry="58.99"
                 transform="translate(-66.58 158.3) rotate(-30)"
                 fill="#455a64" />
        <path
        ...
        <path
          ...
          fill="current" />
        <path
          d="M268.66,210.65l-14.31,9.27a.67.67,0,0,1-1-.84l4.06-9V195.16h11.23Z"
          fill="#ffa8a7" />
        ...
        <path
          ...
          fill="#263238" />
        <polygon
          points="253.34 191.39 253.34 197.42 249.81 196.34 253.34 191.39"
          fill="#f28f8f" />
        <path
          d="M258.66,192a1.23,1.23,0,1,1-1.23-1.23A1.23,1.23,0,0,1,258.66,192Z"
          fill="#263238" />
        <path
          d="M250.57,191.17a1.23,1.23,0,1,1-1.23-1.23A1.23,1.23,0,0,1,250.57,191.17Z"
          fill="#263238" />
        <path
          d="M247.85,188.61l2.4-1.43s-.92-1-1.84-.38A1.67,1.67,0,0,0,247.85,188.61Z"
          fill="#263238" />
        <path
          d="M253.65,199.42a6.3,6.3,0,0,0,4-1.06s.27,2.09-1.48,2.49A2.27,2.27,0,0,1,253.65,199.42Z"
          fill="#f28f8f" />
        <path
        ...
        <path
          ...
          fill="#ffa8a7" />
        <path
          d="M268,236.29a11.21,11.21,0,0,1-12.47,3.43S263.31,245.39,268,236.29Z"
          style={{opacity:0.2}} />
        <path
        ...
        <path
          ...
          fill="current" />
        <text transform="matrix(0.87, 0.5, 0, 1, 245.61, 132.33)"
              style={{fontSize:"10.802305221557617px", fill: "#455a64", fontFamily: "Montserrat-Bold, Montserrat", fontWeight:700}}>Pr
          <tspan x="11.99" y="0"
                 style={{letterSpacing:"-0.007955365951778866em"}}>o
          </tspan>
          <tspan x="18.8" y="0">file</tspan>
        </text>
        <text transform="matrix(0.87, 0.5, 0, 1, 237.18, 260.69)"
              style={{fontSize:"10.731518745422363px", fill: "#455a64", fontFamily:"Montserrat-Bold, Montserrat", fontWeight:700}}>
          <tspan style={{letterSpacing:"-0.06306174446893234em"}}>Y</tspan>
          <tspan x="6.66" y="0">ourname</tspan>
        </text>
        <text transform="matrix(0.87, 0.5, 0, 1, 264.82, 376.61)"
              style={{fontSize:"9.37486743927002px", fill: color, fontFamily:"Montserrat-Bold, Montserrat", fontWeight:700}}>600
          <tspan x="17.35" y="0"
                 fill="#455a64"> Foll</tspan>
          <tspan x="37.91" y="0"
                 fill="#455a64" style={{letterSpacing:"-0.017083334585779753em"}}>ow
          </tspan>
          <tspan x="52.39" y="0" fill="#455a64">ers</tspan>
        </text>
        <text transform="matrix(0.87, 0.5, 0, 1, 198.05, 338)"
              style={{fontSize:"9.37486743927002px", fill: color, fontFamily:"Montserrat-Bold, Montserrat",fontWeight:700}}>500
          <tspan x="17.35" y="0"
                 fill="#455a64"> Foll</tspan>
          <tspan x="37.91" y="0"
                 fill="#455a64" style={{letterSpacing:"-0.017083334585779753em"}}>o
          </tspan>
          <tspan x="43.73" y="0" fill="#455a64">wing</tspan>
        </text>
        <text transform="matrix(0.87, 0.5, 0, 1, 232.81, 271.69)"
              style={{fontSize:"10.731518745422363px", fill: color, fontFamily:"Montserrat-Medium, Montserrat", fontWeight:500}}>@username
        </text>
        <text transform="matrix(0.87, 0.5, 0, 1, 226.42, 288.12)"
              style={{fontSize:"10.731518745422363px", fill: "#455a64", fontFamily:"Montserrat-Medium, Montserrat", fontWeight:500}}>Bio
          description
        </text>
      </g>
      <g id="Character--inject-3">
        ...
        <path
          ...
          fill="current" />
        <path
          d="M160.13,182.37l-16,10.4a.76.76,0,0,1-1.1-.94l4.56-10.15V165h12.59Z"
          fill="#ffa8a7" />
        ...
        <path
          ...
          fill="#263238" />
        <polygon
          points="142.95 160.77 142.95 167.54 138.99 166.32 142.95 160.77"
          fill="#f28f8f" />
        <circle cx="147.54" cy="161.49" r="1.38" fill="#263238"/>
        <path
          d="M139.85,160.53a1.38,1.38,0,1,1-1.38-1.38A1.38,1.38,0,0,1,139.85,160.53Z"
          fill="#263238" />
        <path
          d="M136.79,157.66l2.69-1.61s-1-1.07-2.06-.43A1.9,1.9,0,0,0,136.79,157.66Z"
          fill="#263238" />
        <path
          d="M143.29,169.78a7,7,0,0,0,4.44-1.19s.31,2.34-1.65,2.79A2.55,2.55,0,0,1,143.29,169.78Z"
          fill="#f28f8f" />
        <path
        ...
        <path
          ...
          fill="#ffa8a7" />
        <path
          d="M159.33,211.13s-5.34,7-14,3.85C145.34,215,154.13,221.34,159.33,211.13Z"
          style={{ opacity:0.2 }} />
      </g>
    </svg>
  );
